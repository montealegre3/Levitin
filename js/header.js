...
function header() {
    ...
    const isIndex = path === "/" || path.endsWith("/Levitin/");
    const isAboutPage = path.includes("sobreNosotros.html");
    ...
    if (isIndex) {
                  ...
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse nav-underline justify-content-end" id="navbarNav">
                      <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="./iniciaSesion.html">Iniciar sesión</a>
                        </li>
                        <li class="nav-item dropdown">
                        <a id="btnModulos" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          Módulos
      ...
      `;
        ...
        // Menú para otras páginas (módulos, temas)
